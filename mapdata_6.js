var simplemaps_usmap_mapdata={
  ...
  state_specific: {
    ...
    PA: {
      ...
      description: "A Notice of Intent in Pennsylvania should be sent thirty (30) days prior to filing the mechanic's lien. <br />"
    },
    NJ: {
      name: "New Jersey",
      color: "rgb(213,213,213)",
    ...
    IL: {
      ...
      description: "In the state of Illinois, subcontractors and suppliers should send a Notice of Intent to lien within ninety (90) days from the last day of furnishing labor or materials.<br />"
    },
    CT: {
      name: "Connecticut",
      url: "https://sunray-notice.webflow.io/resources/connecticut",
      description: "For subcontractors and suppliers a Connecticut Notice of intent should be sent within Ninety (90) days from the last day of furnishing labor or materials. <br />"
    },
    WI: {
      name: "Wisconsin",
      url: "https://sunray-notice.webflow.io/resources/wisconsin",
      description: "General Contractors, Subcontractors and Suppliers in Wisconsin should send a Notice of Intent to Lien thirty (30) days prior to filing the mechanic's lien. <br />"
    },
    NC: {
      name: "North Carolina",
      color: "rgb(213,213,213)",
    ...
    AR: {
      name: "Arkansas",
      description: "Subcontractors and suppliers have to send an NOI ten (10) days before filing a mechanic's lien. <br />",
      url: "https://sunray-notice.webflow.io/resources/arkansas"
    },
    MO: {
      name: "Missouri",
      url: "https://sunray-notice.webflow.io/resources/missouri",
      description: "A Notice of Intent should be sent ten (10) days prior to filing the mechanic's lien. <br />"
    },
    GA: {
      name: "Georgia",
      color: "rgb(213,213,213)",
    ...
    LA: {
      ...
      description: "In Louisiana, the rules are slightly changed for projects started after January 1st 2020. A notice of nonpayment should be sent ten(10) days prior to filing the mechanic's lien. <br />"
    },
    MS: {
      name: "Mississippi",
      color: "rgb(213,213,213)",
    ...
    ND: {
      ...
      description: "In North Dakota, a Notice of Intent should be sent ten (10) days prior to filing the mechanic's lien. <br />"
    },
    WY: {
      name: "Wyoming",
      url: "https://sunray-notice.webflow.io/resources/wyoming",
      description: "General Contractors in Wyoming should send a Notice of Intent to Lien twenty (20) days prior to filing the mechanic's lien. Subs and suppliers must send ten (10) days prior to filing the lien. <br />"
    },
    MT: {
      name: "Montana",
      color: "rgb(213,213,213)",
    ...
    CO: {
      name: "Colorado",
      description: "In Colarado, a Notice of Intent should be sent ten (10) days prior to filing your mechanic's lien. <br />",
